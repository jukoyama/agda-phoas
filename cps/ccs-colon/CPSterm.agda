...
-- 値と継続の代入規則
mutual
  data cpsSubstVal𝑐 {var : cpstyp → Set} {cvar : cpstyp → conttyp → Set} : {τ₁ τ₂ τ₃ τ₄ τ₅ τ₆ : cpstyp} →
...
-- cpscont τ₈ → τ₇ ??
  data cpsSubst𝑐 {var : cpstyp → Set} {cvar : cpstyp → conttyp → Set} : {τ₁ τ₂ τ₃ τ₄ τ₅ τ₆ τ₇ τ₈ : cpstyp} →
  ...
  data cpsSubstCont𝑐 {var : cpstyp → Set} {cvar : cpstyp → conttyp → Set} : {τ₁ τ₂ τ₃ τ₄ τ₅ τ₆ τ₇ τ₈ τ₉ : cpstyp} →
    ...
    sKVar≠ : {τ₁ τ₂ τ₃ : cpstyp}
             {v : cpsvalue𝑐[ var , cvar ] τ₃}
             {c : cpscont𝑐[ var , cvar ] (τ₁ ⇒ τ₂) (τ₁ ⇒ τ₂)} {k : cvar {!!} (τ₁ ⇒ τ₂)} →
