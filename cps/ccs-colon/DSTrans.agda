...
mutual
  ...
  dsMain𝑐 τ₁ τ₂ τ₃ e =
    NonVal Hole
    (App Shift
         (Fun (dsT τ₂) (dsT τ₁ ⇒ dsT τ₂ cps[ dsT τ₂ , dsT τ₂ ]) (λ k → dsE𝑐 τ₃ τ₂ τ₂ (e k))))
  ...
  dsC𝑐 : (τ₁ τ₂ τ₃ τ₅ : cpstyp) → {var : typ𝑘 → Set} →
         ...
         pcontext𝑘[ var , dsT τ₁ cps[ dsT τ₂ , dsT τ₃ ]] dsT τ₅
                 cps[ dsT τ₅ , dsT τ₃ ]
  dsC𝑐 τ₁ τ₂ τ₃ .τ₂  (CPSKVar {τ₁ = .τ₁} {τ₂ = .τ₂} k) = Frame (App₂ (Var k)) Hole
  ...
  dsE𝑐 : (τ₃ τ₄ τ₅ : cpstyp) → {var : typ𝑘 → Set} →
         ...
         term𝑘[ var ] dsT τ₅ cps[ dsT τ₅ , dsT τ₃ ]
  dsE𝑐 τ₃ τ₄ .τ₄ (CPSRet {τ₁ = τ₁} {τ₂ = .τ₃} {τ₃ = .τ₄} k v) =
    Val (dsC𝑐 τ₁ τ₃ τ₃ τ₄ k) (dsV𝑐 τ₁ v)
  dsE𝑐 τ₃ τ₄ .τ₄ (CPSApp {τ₁ = τ₁} {τ₂ = τ₂} {τ₃ = τ₅} {τ₄ = .τ₃} {τ₅ = .τ₄} v w k) =
    NonVal (dsC𝑐 τ₁ τ₅ τ₃ τ₄ k)
           (App (dsV𝑐 (τ₂ ⇒[ τ₁ ⇒ τ₅ ]⇒ τ₃) v) (dsV𝑐 τ₂ w))
  dsE𝑐 τ₃ τ₄ .τ₄ {var} (CPSRetE {τ₀ = τ₀} {τ₁ = τ₁} {τ₂ = .τ₃} {τ₃ = .τ₄} k e) =
    NonVal (dsC𝑐 τ₁ τ₃ τ₃ τ₄ k)
