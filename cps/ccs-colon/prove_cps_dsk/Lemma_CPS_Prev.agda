...
correctTerm𝑐𝑠 : {var : cpstyp → Set} → {τ₁ τ₂ τ₃ : typ𝑘} →
                ...
                cpsReduce• {var} (cpsE𝑘 τ₃ τ₂ e)
                                 (cpsE𝑘 τ₃ τ₂ e′)
correctTerm𝑐𝑠 {var} {τ₁} {τ₂} {τ₃} {.(NonVal {_} {τ₄} {τ₃} {τ₃} {τ₂} J (App {_} {τ₄} {(τ₄ ⇒ τ₃ cps[ τ , τ ]) ⇒ τ₂ cps[ τ₂ , τ₃ ]} {τ₃} {τ₃} (Shift {_} {τ} {τ₂} {τ₃} {τ₄} {τ₃}) w))} {.(NonVal {_} {τ₂} {τ₂} {τ₃} {τ₂} (Hole {_} {τ₂} {τ₃}) (App {_} {τ₂} {τ₄ ⇒ τ₃ cps[ τ , τ ]} {τ₂} {τ₃} w (Fun τ₄ τ τ₃ τ {τ} {τ} (λ y k → NonVal {_} {τ} {τ} {τ} {τ} (Hole {_} {τ} {τ}) (Reset τ τ τ (NonVal {_} {τ₃} {τ} {τ} {τ} (KHole {_} {τ₃} {τ} {τ} k) (Reset τ₂ τ₃ τ (Val {_} {τ₄} {τ₃} {τ₂} J (Var {_} {τ₄} y)))))))))} (βShift {τ = τ} {τ₁ = .τ₂} {τ₃ = τ₄} {τ₄ = .τ₃} {J = J} {w = w}) = {!βVal𝑐!}
